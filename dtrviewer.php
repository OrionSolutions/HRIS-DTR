		...
		<div ng-controller="listdtrcrtl">
			<div class="wrapper wrapper-white">
				...
				<div class="container-fluid">
					...
					<div class="col-md-4">&nbsp;
							<input type="date" id="date1" ng-model="dt1" ng-change="dateFilter()" placeholder="Search" class="form-control"/>
							<input type="date" id="date2" ng-model="dt2" ng-change="dateFilter()" placeholder="Search" class="form-control"/>
						</div>
					</div>
