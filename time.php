				...
				<div class="row">
					<div class="col-md-12" ng-show="filteredItems > 0">
						<table class="table table-striped table-bordered">
							<thead>
								<th>Morning In:&nbsp;<a ng-click="sort_by('PositionTitle');"><i class="glyphicon glyphicon-sort"></i></a>
								</th>
								<th>Morning Out:&nbsp;<a ng-click="sort_by('PositionDesc');"><i class="glyphicon glyphicon-sort"></i></a>
                                </th>
								<th>Afternoon In:&nbsp;<a ng-click="sort_by('PositionDesc');"><i class="glyphicon glyphicon-sort"></i></a>
								</th>
                                <th>Afternoon Out:&nbsp;<a ng-click="sort_by('PositionDesc');"><i class="glyphicon glyphicon-sort"></i></a>
								</th>
								<th>Action
								</th>
