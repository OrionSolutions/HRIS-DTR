...
<!DOCTYPE html>
<html ng-app="listofaccount" lang="en">
<head>
    <title>
		<?php echo $title;?>
	</title>
				...
				<div class="row">
					<div class="col-md-12" ng-show="filteredItems > 0">
						<table class="table table-striped table-bordered">
							<thead>
								<th>Username :&nbsp;<a ng-click="sort_by('Username');"><i class="glyphicon glyphicon-sort"></i></a>
								</th>
								<th>Password :&nbsp;<a ng-click="sort_by('Password');"><i class="glyphicon glyphicon-sort"></i></a>
								</th>
				...
				<div class="modal-body">
					...
					<div class="container">
						<form id="saveform">
							...
							<div class="col-lg-6">
								<div class="space-10"></div>
								<input type="text" class="form-control" placeHolder="Username" id="txtusername2" name="txtusername2" required><span class="fa fa-info-circle errspan"></span>
							</div>

							<div class="col-lg-6">
								<div class="space-10"></div>
								<input type="password" class="form-control" placeHolder="Password" id="txtpassword2" name="txtpassword2" required><span class="fa fa-info-circle errspan"></span>
							</div>
...
<script type="text/javascript" src="customjs/account.js"></script>
